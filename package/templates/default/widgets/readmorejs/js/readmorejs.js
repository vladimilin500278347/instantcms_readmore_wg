 ...
 * @editor vladimilin500278347@gmail.com
 * @editor Vlad | https://instantcms.ru/users/12494
 */
        ...
        for (i = 0; i < targetLen; i++) {
            ...
            if (options.numOfWords < targetContentWords - 1) {
                ...
                moreContainer.innerHTML
                    = '<a id="rm-more_' + i + '"'                                               // Create the More/Less link.
                    + ' class="' + options.linkClass + '"'
                    + ' style="' + options.linkColor + options.linkBackColor + options.linkBorderColor + options.linkBorderRadius + options.linkFontSize + options.linkFontWeight + '" data-readmore="anchor">'
                    + options.moreLink
                    + '</a>';
